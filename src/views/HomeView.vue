  ...
  <div class="space-y-10 animate-fade-in max-w-6xl mx-auto">
    ...
    <section class="relative overflow-hidden rounded-2xl border border-cyan-900/40 bg-slate-900/60 p-8 md:p-12 shadow-2xl backdrop-blur-md">
      ...
      <div class="relative max-w-2xl">
        ...
        <h1 class="text-4xl font-black tracking-tight text-white sm:text-5xl lg:text-6xl uppercase">
          Poké<span class="text-cyan-400 font-mono">Matrix</span> OS
        </h1>
    ...
    <section class="grid grid-cols-1 gap-4 sm:grid-cols-3">
      <div class="rounded-xl border border-slate-800/80 bg-slate-900/30 p-5 backdrop-blur-sm flex flex-col justify-between">
        ...
        <div class="mt-4 flex items-baseline gap-2">
          <span class="text-4xl font-black font-mono tracking-wider text-white">
            {{ totalSynced ? totalSynced.toString().padStart(3, '0') : '151' }}
          </span>
      ...
      <div class="rounded-xl border border-cyan-900/30 bg-cyan-950/10 p-5 backdrop-blur-sm flex flex-col justify-between shadow-inner">
        ...
        <div class="mt-4 flex items-baseline gap-2">
          <span class="text-4xl font-black font-mono tracking-wider text-cyan-400">
    ...
    <section class="space-y-4">
      <h2 class="text-[11px] font-bold uppercase tracking-[0.25em] text-cyan-400/70 pl-1">
        Access Terminals
      </h2>
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
        ...
        <RouterLink 
          to="/pokedex" 
          class="group relative overflow-hidden rounded-xl border border-slate-800 bg-slate-900/40 p-6 transition-all duration-300 hover:border-cyan-400/50 hover:bg-cyan-950/20 hover:-translate-y-1 hover:shadow-lg hover:shadow-cyan-950/40"
        >
          ...
          <h3 class="text-base font-black uppercase tracking-wider text-white group-hover:text-cyan-400 transition-colors">
            Database Registry
          </h3>
          <p class="mt-2 text-xs text-slate-400 leading-relaxed">
            Query standard indexes, research elemental strengths, or analyze evolution metrics.
          </p>
          <div class="mt-4 text-[10px] font-bold uppercase tracking-widest text-cyan-400 opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        >
          ...
          <p class="mt-2 text-xs text-slate-400 leading-relaxed">
            Examine individual records locked down for rapid, customized inspection sequences.
          </p>
          <div class="mt-4 text-[10px] font-bold uppercase tracking-widest text-cyan-400 opacity-0 group-hover:opacity-100 transition-opacity">
            Unlock Array →
          </div>
        ...
        >
          ...
          <p class="mt-2 text-xs text-slate-400 leading-relaxed">
            Synchronize cerebral tracking mechanics by running target node pairing protocols.
          </p>
          <div class="mt-4 text-[10px] font-bold uppercase tracking-widest text-cyan-400 opacity-0 group-hover:opacity-100 transition-opacity">
            Boot Protocol →
          </div>
